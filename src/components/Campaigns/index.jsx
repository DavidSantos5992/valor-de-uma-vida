    ...
    return (
        <div className={`w-full md:h-[322.67px] lg:h-[411px] ${mainColor} mt-[120px] flex items-center justify-start relative z-10`}>
            ...
            <div className='sm:w-[110px] md:w-[366px] h-[90%]  border-r-2 border-white-500 flex flex-col items-start sm:ml-[20px] sm:mr-[10px] md:ml-[56px]'>
                ...
                <button className='sm:w-[100px] md:w-[188px] lg:w-[292px] sm:h-[27px] md:h-[35px] lg:h-[47px] bg-white rounded-[20px] flex items-center justify-between box-border md:pl-[30px] sm:pr-[12px] sm:pl-[12px] md:pr-[30px] '>
