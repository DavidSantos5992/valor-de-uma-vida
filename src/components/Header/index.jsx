...
export default function Header() {
    ...
    return (
        <header className='w-full h-[75px] flex items-center justify-between shadow-md font-bold font-sans uppercase box-border pl-[24px] pr-[24px] fixed z-50 bg-white'>
