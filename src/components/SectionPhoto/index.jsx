...
export default function SectionPhoto() {
    return (
        <section className=" lg:w-[1213px] md:w-[758px] mr-auto ml-auto mb-[60px] mt-[60px] font-sans bg-red-300">

            <strong >
                <h3 className="text-shadow font-bold sm:text-[28px] md:text-[38px] text-center lg:text-[67px] ">O Valor de Uma Vida</h3>
            </strong>

            <div className="w-full flex sm:flex-col md:flex-row md:justify-between  mt-[50px] mb-[27px] bg-green-700">
